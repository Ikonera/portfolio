...
const Missions: FunctionComponent = () => {
  ...
  return (
    ...
    >
      <div class="flex justify-between mb-8 items-baseline">
        <div class="relative z-10 w-1/4 text-center">
          <a
            href="https://www.42c.fr"
            target="_blank"
            class={`font-display font-black ${themeValue == "light" ? "text-black" : "text-slate-200"}`}
          >
            42c
          </a>
          <p
            class={`font-body italic ${themeValue == "light" ? "text-black" : "text-slate-200"}`}
          >
            01/10/2020 - 31/09/2023
          </p>
          <div
            class={`absolute left-1/2 h-12 border ${themeValue == "light" ? "border-blue-300" : "border-green-300"} transform translate-y-1/3`}
          ></div>
        </div>
        <div class="w-9/12">
          <p
            class={`font-body ${themeValue == "light" ? "text-black" : "text-slate-200"}`}
          >
      ...
      <div class="flex justify-between mb-8 items-baseline">
        <div class="relative z-10 w-1/4 text-center">
          ...
          <div
            class={`absolute left-1/2 h-9 border ${themeValue == "light" ? "border-blue-300" : "border-green-300"} transform translate-y-1/3`}
          ></div>
        </div>
        <p
          class={`w-9/12 font-body ${themeValue == "light" ? "text-black" : "text-slate-200"}`}
        >
      ...
      <div class="container mx-auto w-max mt-16">
        <button
          class={`rounded-lg border py-2 px-4 border-purple-600 bg-purple-600 text-slate-200`}
        >
          Téléchargez mon CV !
        </button>
      </div>
